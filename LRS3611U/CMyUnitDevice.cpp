...
{
    CMyData::RegisterClass(_T("YK"), RUNTIME_CLASS(CMyDeviceYK), TRUE);
    CMyData::RegisterClass(_T("List"), RUNTIME_CLASS(CMyDeviceList), TRUE);
    CMyUnit::RegisterClass(_T("LRS3611U"), RUNTIME_CLASS(CMyUnitDevice));
}
