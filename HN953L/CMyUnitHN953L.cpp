...
{
    {_T("IN1"), _T("闭锁备自投"), "分位", "合位"},
    {_T("IN2"), _T("弹簧未储能"), "分位", "合位"},
    {_T("IN3"), _T("1DL分闸位置"), "分位", "合位"},
    {_T("IN4"), _T("2DL分闸位置"), "分位", "合位"},
    {_T("IN5"), _T("3DL分闸位置"), "分位", "合位"},
    {_T("IN6"), _T("小车工作位置"), "分位", "合位"},
    {_T("IN7"), _T("小车试验位置"), "分位", "合位"},
    {_T("IN8"), _T("隔离柜工作位置"), "分位", "合位"},
...
//     {_T("Ib"), _T("B相测量电流"), _T("A"), 0x03, 0x01, 1},
    ...
    {_T("IL1"), _T("线路1电流"), _T("A"), 0x02, 0x01, 1},
    {_T("IL2"), _T("线路2电压"), _T("A"), 0x02, 0x01, 1},
};
...
BOOL CMyUnitHN953L::OnCreateData(CMyData* pData)
{
    ...
    {
        ((CMyDataHN953OPList*)pData)->Initialize("故障录波列表");
        return TRUE;
    }
    ...
    if(pData->m_strField==_T("RTWave"))
    {
        ...
        ((CMyRTWave*)pData)->Initialize("实时波形", arChInfo, DFT_NUM);
        return TRUE;
    }
...
{
    {_T("备自投"),   PROTECTACT_NULL},
    {_T("跳电源1"),  PROTECTACT_NULL},
    {_T("跳电源2"),  PROTECTACT_NULL},
