...
#ifndef __CMYUNITDEVICE_H
#define __CMYUNITDEVICE_H
...
class CMyDeviceList:public CMyDataOperate
{
protected:
    DECLARE_SERIAL(CMyDeviceList);
    CMyDeviceList();
...
#define WAVERECORD_DATASIZE     9               //每个录波点数据大小;
...
//---------------------------------------------- CMyDataHN953YK -----------
class CMyDeviceYK:public CMyDataOperate
{
protected:
    DECLARE_SERIAL(CMyDeviceYK);
    CMyDeviceYK();
...
//---------------------------------------------- CMyUnitHN953L ----------------------
class CMyUnitDevice:public CMyUnitModbus
{
public:
    DECLARE_SERIAL(CMyUnitDevice);
    CMyUnitDevice();
    ~CMyUnitDevice();
...
public:
    ...
    CMyDeviceList* m_pWaveRecordList;
...
public:
    void OnOpenList(CMyDeviceList* pOPList);
