// CMyOpenList.cpp : implementation file
//
...
CMyOpenList::CMyOpenList(CWnd* pParent /*=NULL*/)
	: CBCGPDialog(CMyOpenList::IDD, pParent)
{
	//{{AFX_DATA_INIT(CMyOpenList)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CMyOpenList::DoDataExchange(CDataExchange* pDX)
{
	CBCGPDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMyOpenList)
	DDX_Control(pDX, IDC_LIST_PARAM, m_wndLocation);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CMyOpenList, CBCGPDialog)
	//{{AFX_MSG_MAP(CMyOpenList)
	ON_BN_CLICKED(IDC_BUTTON_REFRESH, OnButtonRefresh)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CMyOpenList message handlers
static CMyDataOPList* s_pOPList = NULL;
...
void CMyOpenList::OnButtonRefresh() 
{
